...
Write-Host 'Run the Word alpha smoke runner with powershell -ExecutionPolicy Bypass -File .\scripts\run_word_alpha_smoke.ps1 for the 0.9.0-alpha release gate.'
    }
}
finally {
    Pop-Location
