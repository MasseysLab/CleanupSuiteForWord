...
- `docs/CleanupSuite_User_Manual_v0.9.0-alpha.md`
- `documents/CleanupSuite_User_Manual.pdf` — stable in-app and repository link
- `documents/CleanupSuite_User_Manual_v0.9.0-alpha.pdf` — versioned release copy
...
Older versioned documents remain historical records and are not the current manual.
