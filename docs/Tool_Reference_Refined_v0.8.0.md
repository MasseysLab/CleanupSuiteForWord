...
> Documentation basis: CleanupSuite 0.8.0 as currently prepared in this repository. This reference is meant to reflect the current tool set and current guided-form behavior without pretending that screenshots or every export artifact are already finished.
