...
class PreviewActionPanelTests(unittest.TestCase):
    ...
    def test_shared_preview_panel_helper_exists(self):
        ...
        self.assertIn("StyleLabel lblHint, 9, True", panel)
        self.assertIn("StyleLabel lblSummary, 8.5, False", panel)
        self.assertIn("ctl.Font.Size = 8.5", panel)
        self.assertIn("Const FORM_W As Single = 530", panel)
        self.assertIn("Const FORM_H As Single = 160", panel)
        self.assertIn("Const CONTENT_W As Single = 250", panel)
        self.assertIn("Const BTN_W As Single = 80", panel)
        self.assertIn("Const BH As Single = 17", panel)
        ...
        self.assertIn("lblSummary.Move M, 39, CONTENT_W, 18", panel)
    ...
    def test_apply_and_preview_button_language(self):
        ...
        self.assertIn("Const FORM_W As Single = 530", installer)
        self.assertIn("Const FORM_H As Single = 160", installer)
        self.assertIn("Const CONTENT_W As Single = 250", installer)
        self.assertIn("Const BTN_W As Single = 80", installer)
        self.assertIn("Const BTN_H As Single = 17", installer)
    ...
    def test_return_to_main_after_apply_setting_is_wired(self):
        ...
        self.assertIn('"chkReturnToMainAfterApply", "chkAutoSave", "cmdResetAll"', installer)
        self.assertIn(
