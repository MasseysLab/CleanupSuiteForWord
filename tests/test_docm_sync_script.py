...
class DocmSyncScriptTests(unittest.TestCase):
    ...
    def test_sync_script_includes_runtime_critical_components(self):
        ...
        self.assertIn('"cmdPreviousChange", "cmdPreviousPage", "cmdNextPage", "cmdNextChange",', script)
        self.assertIn('"cmdReviewDetails", "lblReviewContext", "lblButtonMeasure"', script)
